window.WORLD_CUP_BOARD_DATA = {
  ...
  days: {
      ...
      matches: [
        {
          ...
          status: "scheduled",
          minute: "03:00",
          home: { code: "CAN", name: "加拿大", score: null },
          away: { code: "BIH", name: "波黑", score: null },
          venue: "多伦多",
          note: "加拿大迎来队史首个男足世界杯主场比赛，乔纳森-戴维将是进攻焦点。",
          stats: [
            { label: "开球", home: 3, away: 0 },
            { label: "小组", home: 2, away: 2 },
            { label: "看点", home: 5, away: 4 }
          ]
        },
        {
          id: "usa-par",
          ...
          status: "scheduled",
          minute: "09:00",
          home: { code: "USA", name: "美国", score: null },
          away: { code: "PAR", name: "巴拉圭", score: null },
          venue: "洛杉矶",
          note: "美国队在本土开启世界杯征程，普利西奇、麦肯尼领衔的核心阵容迎来大考。",
          stats: [
            { label: "开球", home: 9, away: 0 },
            { label: "小组", home: 4, away: 4 },
            { label: "看点", home: 5, away: 4 }
          ]
        }
      ],
    ...
    "2026-06-14": { label: "6月14日", matches: [], standings: {}, moments: [] },
    "2026-06-15": { label: "6月15日", matches: [], standings: {}, moments: [] }
  }
};
